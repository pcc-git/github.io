...
**Data Science Faculty, Brigham Young University - Idaho**, `Jan 24-Present`

   * Equip undergraduates to become legendary in Data Science-related careers and cultivate sound thinkers able to navigate an industry in constant flux

**Visiting Faculty, Brigham Young University - Idaho**, `Sep 21-Dec 23`
...
**Predictive Modeling**: 
  ...
  - Machine Learning with scikit-learn and TensorFlow+keras in __Python__
  - Multivariate methods, hierarchical models, generalized linear mixed models, supervised and unsupervised learning in __R__

**Data organization and manipulation**:

  - __Python__ Pandas, __R__ Tidyverse

**Data Visualization**

  - seaborn, plotly, altair in __Python__
  - GGPlot in __R__
